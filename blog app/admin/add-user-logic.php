...
if (isset($_POST['submit'])) {
    ...
    if (!$firstname) {
        ...
        $_SESSION['add-user'] = "Password must be 6+ characters";
    } elseif (!$avatar['name']) {
            ...
            if (mysqli_num_rows($user_check_result) > 0) {
                ...
                if (in_array($extension, $allowed_files)) {
                    ...
                    if ($avatar['size'] < 2000000) {
                        ...
                        $_SESSION['add-user'] = "File size too big. File should be less than 1 mb";
                    }
                } else {
    ...
    if (isset($_SESSION['add-user'])) {
        ...
        // $insert_user_query = "INSERT INTO users SET firstname='$firstname', lastname='$lastname', username='$username', email='$email', password='$hashed_password', avatar='$avatar_name, is_admin=0"; like yt video but doesn't work
