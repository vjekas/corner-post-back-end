...
?>
        ...
        <section class="dashboard">
            <!-- shows if add user was successful -->
            ...
            <!-- shows if edit user was successful -->
            ...
            <!-- shows if edit user was an error while updating -->
            ...
            <?php elseif (isset($_SESSION['delete-user'])): ?>
                ...
                <!-- shows if deleting user was successful WE ARE GETTING THIS SESSIONS FORM DELETE-USER.PHP -->
